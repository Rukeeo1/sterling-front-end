...
import {ships } from './ReadMorePageHeader'
...
<>
 ...
 <ReadMorePageHeader page={ships } name={starShip.name} />

<div className="container">

<div className="d-flex flex-column container">
<h1 className="pt-5 pb-4">{starShip.name}</h1>
...
export default  MoreAboutStarShips;