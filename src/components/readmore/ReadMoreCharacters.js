...
function MoreAboutPeople({ match }){
const [people, setPeople] = useState('')
  ...
  useEffect(()=>{
    axios
    .get(`https://swapi.co/api/people/${peopleId}/`)
    .then(response => {
...
<>
 ...
 <ReadMorePageHeader page={characters} name={people.name} />

<div className="container">

<div className="d-flex flex-column container">
<h1 className="pt-5 pb-4">{people.name}</h1>
<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, velit laudantium voluptas natus omnis id doloremque explicabo deserunt temporibus eius tempore aut alias provident beatae doloribus officia molestiae ad est repellat hic? Vitae ipsam totam perferendis laudantium pariatur nostrum ab! Molestias modi itaque quas rerum error earum odit amet nesciunt suscipit hic nemo, aspernatur atque deleniti deserunt, aperiam esse temporibus mollitia excepturi maxime, eos perspiciatis nulla numquam similique! Inventore, ad. Molestias alias, dolor suscipit quisquam architecto quia sequi aut eligendi illum illo omnis eaque reiciendis blanditiis voluptas aliquid, rem aliquam natus nesciunt nobis tenetur incidunt, odio distinctio facere vero. Dolore, veritatis? Fugit, quae eaque laborum, sequi mollitia repellendus molestiae architecto voluptatum doloribus accusantium hic quidem id quasi minima, necessitatibus iure nulla adipisci ducimus doloremque deleniti. Veritatis officiis voluptates dolores, animi eveniet tempore dolorum officia alias explicabo veniam at exercitationem! At totam fuga omnis reprehenderit alias suscipit doloribus dolore accusantium esse delectus rem sint excepturi impedit magni, inventore iusto? Illum impedit unde sed nisi illo eum quos vel. Id expedita dolorum sint magni? Quos totam reiciendis eligendi ipsa cupiditate repellat est asperiores adipisci facilis ratione fugit inventore suscipit odit deleniti, velit dignissimos non vitae dolores, cum porro provident quia eos aspernatur.</p>
...
export default  MoreAboutPeople;