...
function Input(props) {
  ...
  function searchHandler() {
    ...
    if (props.searchtype === 'homepage') {
      axios.all([
        axios.get(`https://swapi.co/api/starships/?search=${searchValue}`), axios.get(`https://swapi.co/api/people/?search=${searchValue}`)
        ]).then(axios.spread((shipRes, peopleRes) => {
    ...
    useEffect(() => {
      ...
      if((results.length || searchValue.length) && props.searchtype === 'homepage') {
      ...
      }else if((results.length || searchValue.length) && (props.searchtype === 'starship' || props.searchtype === 'characters')) {
